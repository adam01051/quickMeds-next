...
const MemberFollowers = (props: MemberFollowsProps) => {
	...
	const isAlreadyFollowing = (follower: Follower) => Boolean(follower.meFollowed?.some((follow) => follow.myFollowing));
								...
								<Box className={'info-box'} component={'div'}>
									{follower?.meLiked && follower?.meLiked[0]?.myFavorite ? (
										<FavoriteIcon
											color="primary"
											onClick={() =>
												memberId && likeMemberHandler(memberId, getMemberFollowersRefetch, followInquiry)
											}
										/>
									) : (
										<FavoriteBorderIcon
